...
<ul>
  <li> **Bonferroni** correction: adjust the significance threshold ($\alpha$) to account for the number of tests (Ntest) being performed.</li>
  <p>
$\alpha_{adjusted}= \frac{\alpha}{\text{Ntest}}$
  </p>
  <p>
$$
\begin{aligned}
