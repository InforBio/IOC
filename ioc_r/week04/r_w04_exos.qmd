...
The analysis result is available via this [link](https://raw.githubusercontent.com/InforBio/IOC/refs/heads/main/ioc_r/week04/toy_DEanalysis.csv).
...
```{r}
de_res <- read.csv(
  file = "toy_DEanalysis.csv",  # replace the path with your own
  header = TRUE
)
```
