...
The significance level ($\alpha$) is the maximum probability of rejecting the null hypothesis (H0) when it is actually true.
This is also called a Type I error (a "false positive").
