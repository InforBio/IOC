...
- **Data Frames**
  ...
  - 2D heterogeneous data, a collection of equal-length vectors of different data types.
...
:::
::: {.column}
- **RDS** format (for preserving a single R object)
...
my_df <- readRDS("outputs/cleaned_gene_expression.rds")
```

- **RData** format (for saving multiple R objects at once)
