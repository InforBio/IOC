...
::: {.columns}
::: {.column}
- **Data Frames**: Your Best Friend for Biological Data

  - 2D heterogeneous data (mix of characters, numbers, logicals).
  - Use `[, ]`, `$`, and `[[ ]]` for indexing.
...
::: {.columns}
::: {.column}
- **Lists**: Storing Everything Together
...
```{r}
classify_expression <- function(expr) {
  if (expr > 20) {
    return("High")
  } else {
    return("Low")
