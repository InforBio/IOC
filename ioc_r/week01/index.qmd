---
title: "Kickstart with ![](images/R_logo.png){width=4.5cm}:<br>Your Gateway to Data Science "
...
An R project keeps everything for your project in **one workspace** and 
...
3. Set a folder name (e.g., `my_project`) and where to save it.
...
``` {.r code-line-numbers="1-3|5-6|8-9|11-12|14-15|17-18"}
# Math with R:
...
- AI (like ChatGPT) is your friend 😉.
